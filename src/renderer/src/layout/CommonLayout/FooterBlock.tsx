                ...
                <Grid item xs={6} sm={4}>
                  <Stack spacing={3}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      <FooterLink href="https://themeforest.net/user/phoenixcoded" underline="none">
                        Profile
                      </FooterLink>
                      <FooterLink
                      ...
                      <FooterLink href="https://phoenixcoded.net" underline="none">
                        Website
                      </FooterLink>
                    </Stack>
                  </Stack>
                ...
                <Grid item xs={6} sm={4}>
                  <Stack spacing={3}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      ...
                      <FooterLink href="https://phoenixcoded.authordesk.app/" underline="none">
                        Support
                      </FooterLink>
                      <FooterLink
                ...
                <Grid item xs={6} sm={4}>
                  <Stack spacing={3}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      ...
                      <FooterLink href="https://themeforest.net/licenses/standard" underline="none">
                        Licenses Term
                      </FooterLink>
                    </Stack>
                  </Stack>
